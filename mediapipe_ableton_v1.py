...
while True:
    ...
    if results.multi_hand_landmarks and len(results.multi_hand_landmarks) == 2:
        ...
        # === Calcular distancias entre manos ===
        thumb_distance = math.dist((thumb1.x, thumb1.y), (thumb2.x, thumb2.y))
        index_distance = math.dist((index1.x, index1.y), (index2.x, index2.y))

        # === Escalar valores (ajusta rangos según tu cámara) ===
        thumb_scaled = scale(thumb_distance, 0.05, 0.4, 0, 1)  # Distancia pulgares
        index_scaled = scale(index_distance, 0.05, 0.4, 0, 1)  # Distancia índices
        ...
        # Círculos en los puntos de interés
